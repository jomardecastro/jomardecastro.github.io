								...
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-omega/">
												Argent Omega </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-guardian/">
												Argent Guardian Ultra </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-aws/">
												Argent AWS </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-console/">
												Argent Console </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-sentinel/">
												Argent for SharePoint </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-exchange/">
												Argent for Exchange </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-java/">
												Argent for Java </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/356-2/">
												Argent for SNMP </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-for-storage/">
												Argent for Storage </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-xenapp/">
												Argent for XenApp </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-for-active-directory/">
												Argent for Active Directory </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-sap/">
												Argent for SAP </a> </li>
									</ul>
									<!-- Tabs List -->
								</div>
						...
						<div class="card">
							...
							<div id="collapse-11" class="collapse " aria-labelledby="heading-11" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/batch-job-automation/">
												Argent Job Scheduler </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-worldview/">
						...
						<div class="card">
							...
							<div id="collapse-13" class="collapse " aria-labelledby="heading-13" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-sentinel-2/">
												Argent Sentinel </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-sentry-ultra/">
						...
						<div class="card">
							...
							<div id="collapse-14" class="collapse " aria-labelledby="heading-14" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-for-compliance/">
												Argent for Compliance </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-for-security/">
						...
						<div class="card">
							...
							<div id="collapse-15" class="collapse " aria-labelledby="heading-15" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-for-hyper-v/">
												Argent for Hyper-V </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-vmware/">
												Argent for VMware </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-for-xenserver/">
						...
						<div class="card">
							...
							<div id="collapse-16" class="collapse " aria-labelledby="heading-16" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-boardroom/">
												Argent BoardRoom </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-commander/">
												Argent Commander </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-global-manager/">
												Argent Global Manager </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-reports/">
												Argent Reports </a> </li>
									</ul>
									<!-- Tabs List -->
								</div>
						...
						<div class="card">
							...
							<div id="collapse-17" class="collapse " aria-labelledby="heading-17" data-parent="#accordion">
								<div class="card-body">
									...
									<ul class="nav nav-tabs" id="myTab" role="tablist">
										<li class="nav-item"> <a class="nav-link active"
												href="https://www.argent.com/product/argent-for-mysql/">
												Argent for MySQL </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-oracle/">
												Argent for Oracle </a> </li>
										<li class="nav-item"> <a class="nav-link "
												href="https://www.argent.com/product/argent-for-sql-server/">
												Argent for SQL Server </a> </li>
										<li class="nav-item"> <a class="nav-link " href="https://www.argent.com/product/argent-for-sybase/">
